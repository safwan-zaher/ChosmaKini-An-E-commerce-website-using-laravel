...
<head>
	...
	<!-- start: CSS -->
	<link rel="stylesheet" href="{{asset('https://cdn.jsdelivr.net/bootstrap.tagsinput/0.8.0/bootstrap-tagsinput.css')}}">
	<script src="{{asset('https://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.2/jquery.min.js')}}"></script>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>Lenskart-KUET</span></a>
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{url('/subcategories/create')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Sub Category</span></a></li>
								<li><a class="submenu" href="{{url('/subcategories')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Sub Category</span></a></li>
							</ul>	
						</li>
						<li>
